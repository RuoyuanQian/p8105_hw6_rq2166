...
First of all, I put all variables into the regression, and select variables with p-value smaller than 0.05. Finally, built a new model with selected variables as the final model.
